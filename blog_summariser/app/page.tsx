...
export default function Home() {
  ...
  return (
    <div
      className="flex flex-col justify-start items-center min-h-screen  min-w-screen font-mono space-y-4 text-center"
      style={{
    ...
    >
      ...
      <Card className="w-[90%] max-w-2xl mx-4 text-center text-2xl sm:text-3xl font-semibold mt-2 bg-[#393E46] border-0 text-[#00ADB5] shadow-md shadow-[#00ADB5]">
        <CardHeader>
